...
const statuses = [
  ...
  },
  {
    ...
    detail: "The system has assigned a unique reference number and notified the Sub-County Director. The school cannot edit the SIP after SCDE approval.",
  ...
  {
    label: "CDE Validated",
    description: "County Director has validated the approval. Forwarded to Project Coordination Unit.",
    detail: "The CDE confirmed alignment with school priorities. The SIP now awaits fund authorization from the Project Coordination Unit.",
  ...
  {
    label: "Authorized",
    description: "Project Coordination Unit has authorized fund release.",
    detail: "The Project Coordination Unit has issued authorization. Disbursement to the school account is now in process.",
